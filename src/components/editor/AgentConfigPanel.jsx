      ...
      <div className="p-6 space-y-6">
        ...
        <div>
          ...
          <div className="relative">
            ...
            />
            <div className="absolute top-2.5 right-3 opacity-20 pointer-events-none">
              <span className="material-symbols-outlined text-on-surface-variant" style={{ fontSize: 16 }}>psychology</span>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            />
            <div className="absolute top-2.5 right-3 opacity-20 pointer-events-none">
              <span className="material-symbols-outlined text-on-surface-variant" style={{ fontSize: 16 }}>target</span>
            </div>
          </div>
